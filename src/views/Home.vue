...
export default {
  ...
  methods: {
    ...
    getLeagues(id) {
      return new Promise(() => {
        axios.get(process.env.VUE_APP_API_URL + 'league.php?league=' + id).then(response => {
    ...
    getTeamById(id, name) {
      axios.get(process.env.VUE_APP_API_URL + 'team.php?id=' + id).then(response => {
    ...
    isFrench(id) {
      return new Promise(resolve => {
        let isFrench = false
        axios.get(process.env.VUE_APP_API_URL + 'profil.php?id=' + id).then(response => {
